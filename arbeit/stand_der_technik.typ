...
Mit Punktwolken kann auch die Baumspezies bestimmt werden. Dafür kann die Verteilung der Punkte zugehörig zur Baumkrone benutzt werden @tree_ident. Mit hochauflösenden Daten kann ein Profil für die Rinde bestimmt werden, welches für die Einordnung verwendet wird @tree_bark.
