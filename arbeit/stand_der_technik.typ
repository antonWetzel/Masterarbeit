...
In der Arbeit von #cite( <simple_tree>, form: "prose") beschäftigt sich mit der Berechnung vom Holzvolumen von einem Baum. Dafür wird der Baum mit Zylindern rekonstruiert, aus denen das totale Volumen berechnet wird. Für die Rekonstruktion können auch neuronale Ansätze verwendet werden @neural_decomp.
